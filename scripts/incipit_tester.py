...
sys.path.insert(0, '/Users/ahankins/Documents/code/rism/Verovio/verovio/bindings/python/')
import verovio
# When using a local version
verovio.setDefaultResourcePath('/Users/ahankins/Documents/code/rism/Verovio/verovio/data')
...
r = c.search("*:*", fq=fq, rows=1000, cursorMark="*", fl=["id", "original_pae_sni"], sort="id asc")
